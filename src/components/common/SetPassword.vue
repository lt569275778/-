<template>
<el-dialog title="修改密码" :visible.sync="form.modal" size="tiny" width="300" @close="handleCloseCallback('form')">
    ...
    <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click.native="submitpassword" :loading="form.loading">确认提交</el-button>
    </div>
</el-dialog>
</template>
